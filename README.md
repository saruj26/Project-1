...
Run the frontend:
npm run dev
Run the backend: - Open a terminal in your project root and run: bash php -S localhost:8080  - If you use XAMPP/WAMP, make sure to set the document root to the backend/ folder and configure the port to 8080 to match the frontend API calls. Otherwise, it is recommended to use: bash php -S localhost:8080  for consistent results.
Usage
